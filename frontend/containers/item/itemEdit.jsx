    ...
    <Fragment>
      ...
      <div className="container">
        ...
        <form className="form-horizontal">
          ...
          <StorySettingSelect validatedOnce={validatedOnce} storyId={storyId} type="itemType" i18n={i18n} storySettingStore={storySettingStore} onChange={setType} value={type} />
        ...
        <Tabs
          ...
          tabValues={[
            { tabName: i18n.t('item.view.tabs.statistic'), render: () => <StorySettingListSelect {...props} storyId={storyId} type="trait" subType="statistic" onChange={handleSetStatisticTrait} values={statisticTraits} /> },
            { tabName: i18n.t('item.view.tabs.requiredStatistic'), render: () => <StorySettingListSelect {...props} storyId={storyId} type="trait" subType="statistic" onChange={handleSetReqStatisticTrait} values={reqStatisticTraits} /> },
          ]}
        />
      </div>
    </Fragment>
