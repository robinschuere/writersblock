...
const UserEdit = ({
  ...
  const [persistLogin, setPersistLogin] = useState(user.persistLogin);
    ...
    <Fragment>
      ...
      <div className="container">
        ...
        <form className="form-horizontal">
          ...
          <LabelAndField type="text" label={i18n.t('user.firstname')} placeholder={i18n.t('user.placeholders.firstname')} onChange={setFirstName} value={firstName} />
          <LabelAndField type="text" label={i18n.t('user.lastname')} placeholder={i18n.t('user.placeholders.lastname')} onChange={setLastName} value={lastName} />
          <LabelAndField type="date" label={i18n.t('user.dateOfBirth')} onBlur={setDateOfBirth} value={dateOfBirth} />
          <LabelAndField type="select" options={getYesNoOptions(i18n)} label={i18n.t('user.persistLogin')} onChange={setPersistLogin} value={persistLogin} />
